...
It's behaviour is further explained in [Privacy Policy](https://github.com/dv8-studio/RobloxURLLauncher/blob/master/PRIVACY.md)

This extension should work wherever Roblox launcher itself works (Windows, Mac OS). 
DOES NOT WORK ON CHROME OS AS LONG AS ROBLOX ITSELF DOESN'T SUPPORT IT

Disclaimer: This extension was NOT made to bypass Roblox security. For instance you won't be able to join a game you don't normally have access to or join server of player you can't follow.
...
Webpage will be automatically closed after launching the app unless `dontClose=1` parameter is present in the link.
Above expamples contain `https://www.roblox.com/home` base, but you may also use:
